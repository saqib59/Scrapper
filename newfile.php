...
for ($i=1;$i<=6;$i++){
# code...
$url = file_get_html("https://www.dfwfurniturewarehouse.com/category/showsorted/allpage/500/layout/yes/fromajax/true?keyword=&subcategory%5B%5D=67&categoryid=2&pagenumber=$i&keyword=&categoryid=2&allpage=500&sortbydropdown=1&subcategory%5B%5D=198");
...
foreach ($website_url->find('.ProDtlCnt') as $inner){
 ...
 $Description=$inner->find('.customtabs .customtabsp',0)->outertext;
 ?>
  <tr>
